...
class RefreshIcon : public ToolbarIcon
{
public:
	RefreshIcon(Game* r_pGame, point r_point, int r_width, int r_height, string img_path);
	virtual void onClick();
};
...
class Load1Icon : public ToolbarIcon
{
public:
	Load1Icon(Game* r_pGame, point r_point, int r_width, int r_height, string img_path);
	virtual void onClick();
};
...
{
	ICON_RESTART, ICON_EXIT, ICON_COUNT
};
