...
struct  //contains all game configurations (MAY be loaded from a configuration file later)
{
	...
	int	windowWidth = 1200, windowHeight = 900,	//Window width and height
			//Playing area width
	...
	int playAreaHeight = windowHeight - toolBarHeight;

	// Remaining Height 
	int playingAreaHeight = windowHeight - toolBarHeight - statusBarHeight;
